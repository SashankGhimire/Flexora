// Icon components for the admin dashboard
...
export const WorkoutIcon = ({ className = 'w-5 h-5', size }: IconProps) => (
  <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
...
export const PieChartIcon = ({ className = 'w-5 h-5', size }: IconProps) => (
  <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
    <circle cx="12" cy="12" r="10" />
    <path d="M12 12v-10" />
    <path d="M12 12L6.39 5.61" />
  </svg>
);
